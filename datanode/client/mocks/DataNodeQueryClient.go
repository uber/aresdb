...
// Query provides a mock function with given fields: ctx, host, _a2
func (_m *DataNodeQueryClient) Query(ctx context.Context, host topology.Host, _a2 query.AQLQuery) (common.AQLQueryResult, error) {
