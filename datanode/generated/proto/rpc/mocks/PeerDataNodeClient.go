...
func (_m *PeerDataNodeClient) Health(ctx context.Context, in *rpc.HealthCheckRequest, opts ...grpc.CallOption) (*rpc.HealthCheckResponse, error) {
	...
	var r0 *rpc.HealthCheckResponse
	if rf, ok := ret.Get(0).(func(context.Context, *rpc.HealthCheckRequest, ...grpc.CallOption) *rpc.HealthCheckResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*rpc.HealthCheckResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *rpc.HealthCheckRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
