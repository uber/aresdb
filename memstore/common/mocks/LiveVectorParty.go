...
func (_m *LiveVectorParty) GetValue(offset int) (Pointer, bool) {
	ret := _m.Called(offset)

	var r0 Pointer
	if rf, ok := ret.Get(0).(func(int) Pointer); ok {
		r0 = rf(offset)
	} else {
...
func (_m *LiveVectorParty) SetValue(offset int, val Pointer, valid bool) {
	_m.Called(offset, val, valid)
}
