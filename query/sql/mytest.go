...
func (v MyVisitor) Visit(tree antlr.ParseTree) interface{} {
	fmt.Println("Visit", tree.GetText(), tree.)
	return tree.Accept(v)
}

func (v MyVisitor) VisitChildren(node antlr.RuleNode) interface{} {
	fmt.Println("VisitChildren", node.GetChildCount(), node.GetText())
...
func (v MyVisitor) VisitErrorNode(node antlr.ErrorNode) interface{} {
	fmt.Println("VisitErrorNode", node)
	return nil
}

func (v MyVisitor) VisitSingleStatement(ctx *antlrgen.SingleStatementContext) interface{} {
	fmt.Println("VisitSingleStatement", ctx.GetText())
	return nil
}

// Visit a parse tree produced by SqlBaseParser#singleExpression.
func (v MyVisitor) VisitSingleExpression(ctx *antlrgen.SingleExpressionContext) interface{} {
	return v.VisitChildren(ctx)
}

// Visit a parse tree produced by SqlBaseParser#statementDefault.
func (v MyVisitor) VisitStatementDefault(ctx *antlrgen.StatementDefaultContext) interface{} {
	return v.VisitChildren(ctx)
}

// Visit a parse tree produced by SqlBaseParser#queryNoWith.
func (v MyVisitor) VisitQueryNoWith(ctx *antlrgen.QueryNoWithContext) interface{} {
	fmt.Println("fun part!!")
	return v.VisitChildren(ctx)
}
...
func main() {
	...
	// Setup the input sql
	is := util.NewCaseChangingStream(antlr.NewInputStream(queryString), true)
	...
	parseTree, ok := p.QueryNoWith().(*antlrgen.QueryNoWithContext)
	if !ok {
		fmt.Println("err!!!!  no query")
	}
	fmt.Printf("%+v\n", parseTree)
	parseTree.Accept(MyVisitor{})
}
