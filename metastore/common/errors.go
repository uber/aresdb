...
var (
	...
	ErrInvalidPrimaryKeyDataType         = errors.New("Array data type can not used as primary key")
	ErrInvalidSortColumnDataType         = errors.New("Array data type can not used as sorting column")
)
