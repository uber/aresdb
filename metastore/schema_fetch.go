...
type SchemaFetchJob struct {
	...
	controllerClient  gateways.ControllerClient
	stopChan          chan struct{}
}

// NewSchemaFetchJob creates a new SchemaFetchJob
func NewSchemaFetchJob(intervalInSeconds int, schemaMutator TableSchemaMutator, schemaValidator TableSchemaValidator, controllerClient gateways.ControllerClient, clusterName, initialHash string) *SchemaFetchJob {
